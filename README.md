...
~~~sh
# getting the code
git clone git@github.com:nko5/aono.git && cd ./aono/
...
# deploying to Modulus (to http://aono.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/aono" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
